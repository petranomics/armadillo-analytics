    ...
    try {
      ...
      const newData: PlatformData = {
        ...
        summary: {
          ...
          avgEngagementRate: rawPosts.length > 0 ? parseFloat((rawPosts.reduce((s, p) => s + p.engagementRate, 0) / rawPosts.length).toFixed(1)) : 0,
          topPost: rawPosts.sort((a, b) => (b.metrics.likes + b.metrics.comments) - (a.metrics.likes + a.metrics.comments))[0] || rawPosts[0],
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex items-start justify-between mb-8">
        <div className="flex items-center gap-4">
          <div
            ...
            style={{ backgroundColor: `var(--color-platform-${profile.platform})`, color: profile.platform === 'tiktok' ? '#000' : '#fff' }}
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        ...
        <EngagementDonut likes={totalLikes} comments={totalComments} shares={totalShares} saves={totalSaves > 0 ? totalSaves : undefined} />
      </div>
