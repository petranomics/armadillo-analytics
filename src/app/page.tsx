...
export default function DashboardPage() {
  ...
  return (
        <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-start justify-between mb-8">
                      <div>
                                <div className="flex items-center gap-3">
                                            <h1 className="font-display text-3xl text-armadillo-text">Dashboard</h1>h1>
          ...
          {/* Connected Platforms */}
              <div className="bg-armadillo-card border border-armadillo-border rounded-xl p-5 mb-6">
                      <div className="flex items-center justify-between mb-4">
                                <span className="text-[10px] font-semibold text-armadillo-muted tracking-widest uppercase">Connected Platforms</span>span>
                      ...
                      <Link
                                    ...
                                    <div>
                                                    <div className="text-sm font-medium text-armadillo-text">{PLATFORM_NAMES[platform]}</div>div>
                    ...
                    return (
                                  <button
                                                ...
                                                <div className="flex items-center gap-1.5 mb-2">
                                                                <span className="text-base">{metric.icon}</span>span>
                                                                <span className="text-[10px] text-armadillo-muted uppercase tracking-wider font-medium truncate">{metric.label}</span>span>
                                                </div>div>
                                                <div className="font-display text-3xl text-armadillo-text mb-1">{value}</div>div>
                                                ...
                                                return (
                                                                    <div key={metric.id} className={i < categoryMetrics.length - 1 ? 'border-b border-armadillo-border/50' : ''}>
                                                                                        <button
                                                                                                              ...
                                                                                                              >
                                                                                                              <span className="text-base shrink-0">{metric.icon}</span>span>
                                                                                                              <div className="flex-1 min-w-0">
                                                                                                                                      <div className="text-sm font-medium text-armadillo-text">{metric.label}</div>div>
                                                                                                                                      <div className="flex items-center gap-1 mt-0.5">
                                                                                                                                                                <Sparkles size={8} className="text-burnt shrink-0" />
                                                                                                                                                                <p className="text-[11px] text-armadillo-muted truncate">{aiLine}</p>p>
                                                                                                                                        </div>div>
                                                                                                                </div>div>
                                                                                                              <div className="text-right shrink-0">
                                                                                                                                      <div className="text-base font-display text-armadillo-text">{value}</div>div>
                                                                                            ...
                                                                                            <div className="px-5 pb-4 -mt-1 space-y-2">
                                                                                                                    <div className="bg-burnt/5 border border-burnt/20 rounded-xl p-3">
                                                                                                                                              <div className="flex items-start gap-2">
                                                                                                                                                                          ...
                                                                                                                                                                          <p className="text-xs text-armadillo-text/80 leading-relaxed">{aiLine}</p>p>
                                                                                                                                                </div>div>
                                                                                                                      </div>div>
                                                                                                                    <div className="flex items-start gap-2 px-1">
                                                                                                                                              <Info size={10} className="text-armadillo-muted shrink-0 mt-0.5" />
                                                                                                                                              <p className="text-[10px] text-armadillo-muted/70 leading-relaxed">{metric.description}</p>p>
                                                                                                                      </div>div>
                                                                                              </div>div>
                                                                                        )}
                                                                    </div>div>
          ...
          {/* Quick Actions */}
              <div className="mb-6">
                      <h3 className="text-[10px] font-semibold text-armadillo-muted tracking-widest uppercase mb-3">Quick Actions</h3>h3>
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                                <Link href="/insights" className="bg-burnt/10 border border-burnt/30 rounded-xl p-5 hover:border-burnt/50 transition-colors group">
                                            ...
                                            <div className="text-sm font-medium text-burnt">AI Insights</div>div>
                                            <div className="text-[10px] text-armadillo-muted mt-0.5">View your AI analytics writeup</div>div>
                                </Link>Link>
                                <Link href="/export" className="bg-armadillo-card border border-armadillo-border rounded-xl p-5 hover:border-burnt/40 transition-colors group">
                                            ...
                                            <div className="text-sm font-medium text-armadillo-text">Export Report</div>div>
                                            <div className="text-[10px] text-armadillo-muted mt-0.5">Share with brands or clients</div>div>
                                </Link>Link>
                                <Link href="/customize" className="bg-armadillo-card border border-armadillo-border rounded-xl p-5 hover:border-burnt/40 transition-colors group">
                                            ...
                                            <div className="text-sm font-medium text-armadillo-text">Customize Metrics</div>div>
                                            <div className="text-[10px] text-armadillo-muted mt-0.5">Add or remove tracked metrics</div>div>
                                </Link>Link>
                                <Link href="/settings" className="bg-armadillo-card border border-armadillo-border rounded-xl p-5 hover:border-burnt/40 transition-colors group">
                                            ...
                                            <div className="text-sm font-medium text-armadillo-text">Platform Settings</div>div>
                                            <div className="text-[10px] text-armadillo-muted mt-0.5">Manage connected accounts</div>div>
                                </Link>Link>
                      </div>div>
              </div>div>
        </div>div>
