...
function TrendingHashtags() {
  ...
  // Lazy-load: show button until first fetch
  if (!fetched && !loading) {
    return (
      <div className="bg-armadillo-card border border-armadillo-border rounded-xl p-6">
        ...
        <p className="text-xs text-armadillo-muted mb-4">
          See which hashtags are trending, their post volumes, and related tags. Data is fetched on demand from live sources.
        </p>
        <button
          onClick={fetchTrends}
